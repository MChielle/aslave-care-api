...
namespace SlaveCare.Infra.Data.Migrations
{
    ...
    [Migration("20250410231535_ChangeRegistryInAddNumber")]
    partial class ChangeRegistryInAddNumber
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SlaveCare.Domain.Entities.Stock", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SlaveCare.Domain.Entities.UserValidation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("SlaveCare.Domain.Entities.RegistryInStock", b =>
                {
                    b.HasOne("SlaveCare.Domain.Entities.RegistryIn", "RegistryIn")
                        .WithMany("RegistryInStocks")
                        .HasForeignKey("RegistryInId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("SlaveCare.Domain.Entities.Stock", "Stock")
                        .WithMany("StockRegistryIns")
                        .HasForeignKey("StockId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("RegistryIn");
            ...
            modelBuilder.Entity("SlaveCare.Domain.Entities.User", b =>
                {
                    b.HasOne("SlaveCare.Domain.Entities.UserValidation", "UserValidation")
                        .WithMany()
            ...
            modelBuilder.Entity("SlaveCare.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("SlaveCare.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
